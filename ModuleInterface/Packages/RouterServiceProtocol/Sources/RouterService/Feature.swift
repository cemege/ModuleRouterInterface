...
public protocol Feature {
    func build(fromRoute: Route?) -> UIViewController
    func resolve(withStore store: StoreProtocol)
...
extension Feature {
    public func resolve(withStore store: StoreProtocol) {
...
extension Feature {
    static func initialize(withStore store: StoreProtocol) -> Feature {
